...
export default function EstimationCalculator({ onBack, initialCategory = 'menu', activeProjectName, onAutoSave, activeProject, materials }) {
  ...
  const copy = useMemo(() => lang === 'ku' ? {
    title: 'ژمێرەری خەمڵاندن - زەڕعە',
    ...
    materials: {
      ...
      paint: { title: 'بۆیەکردن', icon: '🎨', desc: 'بڕی بۆیەی پێویست بۆ دیوار' },
      tile: { title: 'سیرامیک و کاشی', icon: '🔲', desc: 'ژمارەی کاشی، مادەی لکێنەر' },
      plaster: { title: 'گێچ و لەبخ', icon: '🏠', desc: 'ڕووبەڕی گێچکاری و ژمارەی کیسە' },
      rebar: { title: 'شیشی ئاسن', icon: '⛓️', desc: 'کێشی شیش بە تۆن و ژمارەی دانە' },
      isogam: { title: 'ایزۆگام (بنبانی)', icon: '💧', desc: 'ڕۆڵی ایزۆگام و قیر (زفت)' },
    ...
    totalVolume: 'قەبارەی گشتی کۆنکریت (لەگەڵ بەفیڕۆچوون)',
    netPaint: 'بۆیەی پێویست (٢ قاتی خاوێن)',
    totalPaint: 'کۆی گشتی بۆیە (لەگەڵ بەفیڕۆچوون)',
    ...
    piecesLabel: 'دانە',
    tonnesLabel: 'تۆن',
    totalRolls: 'کۆی ڕۆڵەکانی ایزۆگام (١٠م٢)',
    primerLiters: 'قیر (زفت) بۆ ژێرەوە (لیتر)',
    totalPanels: 'کۆی پارچەکانی گەچ بۆرد',
    framingPieces: 'شیشی ئاسنی C-Channel (نزیکەیی)',
    infoBlock: 'تێبینی: بۆ دیواری بلۆک ٥٪ و خشت ٨٪ بەفیڕۆچوون دانراوە. چیمەنتۆ بە ٤٠٠کگم بۆ هەر مەتر سێجایەک مەزەندە کراوە.',
    infoBrick: 'تێبینی: ڕێژەی بەفیڕۆچوون ٨٪ دانراوە. ئەستووری دیوارەکەت ١٢ سم هەژمار کراوە بۆ بڕی چیمەنتۆی پێویست.',
    infoConcrete: 'تێبینی: رێژەی ٥٪ بەفیڕۆچوون دانراوە. گیراوەی کۆنکریتەکە بۆ هەر م٣ نزیکەی ٣٥٠کگم چیمەنتۆی بۆ هەژمار کراوە (C25).',
    infoPaint: 'تێبینی: بەفیڕۆچوون ١٠٪. بڕەکە بۆ ٢ قاتی بۆیە هەژمار کراوە.',
    infoTile: 'تێبینی: بەفیڕۆچوونی کاشی ١٠٪ دانراوە بەهۆی بڕینەوە. بڕی مادەی لکێنەر بۆ هەر م٢ نزیکەی ٤کگم مەزەندە کراوە.',
    infoPlaster: 'تێبینی: بەفیڕۆچوونی گێچ ١٥٪ دانراوە کە باوە لە عێراق. کێشی گێچ بۆ هەر م٣ ١٢٥٠ کگم هەژمار کراوە.',
    infoRebar: 'تێبینی: کێش بە هاوکێشەی جیهانی ئەندازیاری D²/162 هەژمار کراوە بەبێ بەفیڕۆچوون.',
    infoIsogam: 'تێبینی: ١٥٪ زیادە بۆ یەکتربڕین و سەرکەوتن (Overlap) بۆ سەربان دانراوە. قیر (Primer) بە ٠.٣ لیتر بۆ م٢ هەژمار کراوە.',
    infoGypsum: 'تێبینی: ١٠٪ بەفیڕۆچوون بۆ پارچەکان دانراوە. شیشی C-Channel بە نزیکەیی ٣.٢ مەتر بۆ هەر م٢ هەژمار کراوە.',
  } : {
            ...
            <View style={{ backgroundColor: "#EBF5FF", paddingHorizontal: 16, paddingVertical: 12, marginBottom: 20, borderRadius: 12, flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: '#BFDBFE' }}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: "#3B82F6", fontWeight: '600', fontSize: 11, textAlign: isRTL ? 'right' : 'left' }}>
                  {lang === "ku" ? "گۆڕانکارییەکان خۆکارانە پاشەکەوت دەکرێن کاتێک دەگەڕێیتەوە" : "Changes are saved automatically when you go back"}
                </Text>
              </View>
            </View>
          )}
